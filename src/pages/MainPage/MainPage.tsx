...
const columns: GridColDef[] = [
  ...
  { field: 'dob', headerName: 'DOB', width: 120 },
  {
    ...
    width: 100,
    renderCell: (params) => (
      <Box sx={cellLabelSX}>{params.value === 'F' ? <FemaleIcon style={{ color: 'pink' }} /> : <MaleIcon style={{ color: 'blue' }} />}</Box>
    ),
  },
  {
    field: 'billing_class',
    ...
    renderCell: (params) => (
      <Box sx={cellLabelSX}>
        {' '}
        <CellLabelComponent color={cellLabelColor(params.value)} value={params.value} />{' '}
      </Box>
    ),
  },
  ...
  { field: 'dos_from', headerName: 'Date of Service', width: 150 },
  {
    ...
    headerName: 'Rev Code',
    width: 120,
    renderCell: (params) => <Box sx={cellLabelSX}> {params.value ? <Typography>{params.value}</Typography> : <CloseIcon />} </Box>,
  },
              ...
              <CustomTabPanelComponent value={value} index={0}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                  ...
                  <SimpleTextComponent label={'Gender'}>
                    <Box>
                      {selectedRowData?.gender === 'F' ? <FemaleIcon style={{ color: 'pink' }} /> : <MaleIcon style={{ color: 'blue' }} />}
                    </Box>
                  </SimpleTextComponent>
